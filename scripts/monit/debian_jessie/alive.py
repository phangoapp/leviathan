...
if check_url.match(args.url):
    ...
    with open('vendor/phangoapp/leviathan/scripts/monit/debian_jessie/files/crontab/alive') as f:
        alive_cron=f.read()
    ...
    with open('vendor/phangoapp/leviathan/scripts/monit/debian_jessie/files/get_info.py') as f:
        get_info=f.read()
    ...
    with open('vendor/phangoapp/leviathan/scripts/monit/debian_jessie/files/get_updates.py') as f:
        get_updates=f.read()
    ...
    with open('vendor/phangoapp/leviathan/scripts/monit/debian_jessie/files/sudoers.d/spanel') as f:
        sudoers=f.read()
    ...
    if call("sudo cp vendor/phangoapp/leviathan/scripts/monit/debian_jessie/files/crontab/alive /etc/cron.d/alive", shell=True) > 0:
    ...
    if call("mkdir /home/"+args.user+"/bin/ && cp vendor/phangoapp/leviathan/scripts/standard/debian_jessie/upgrade.sh /home/"+args.user+"/bin/ && chown -R "+args.user+":"+args.user+" /home/"+args.user+"/bin/", shell=True) > 0:
